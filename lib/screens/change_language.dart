...
import 'package:elhasnaa/repositories/language_repository.dart';
...
class _ChangeLanguageState extends State<ChangeLanguage> {
  ...
  onLanguageItemTap(index) {
    if (index != _selected_index) {
      ...
      print('app lang = ${_list[_selected_index].code}');
      print('app_mobile_language = ${_list[_selected_index].mobile_app_code}');
      print('app_language_rtl = ${_list[_selected_index].rtl}');
  ...
  Container buildCheckContainer(bool check) {
    return check
      ...
      child: const Padding(
        ...
        child: Icon(FontAwesomeIcons.check, color: Colors.white, size: 10),
      ),
    )
        : Container();
  }
