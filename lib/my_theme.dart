...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(150,46,4, 1);
  // static Color accent_color = Colors.blue;
  static Color soft_accent_color = Color.fromRGBO(150,189,168, 1);
  static Color splash_screen_color = Color.fromRGBO(240,180,160, 1); // if not sure , use the same color as accent color
